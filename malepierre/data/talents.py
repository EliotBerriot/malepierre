...
DATA = [
    ...
    },
    {
        'code': 'effrayant',
        'name': 'Effrayant',
        'description': 'vous avez une apparence effrayante.Vous provoquez la Peur, comme indiqué dans le Chapitre 9 : Le meneur de jeu.',
    },
    {
        'code': 'eloquence',
        'name': 'Éloquence',
    ...
    },
    {
        'code': 'levitation',
        'name': 'Lévitation',
        'description': 'vous pouvez voler sur une courte distance au-dessus du sol. Pour plus de détails concernant le vol, reportez-vous au Chapitre 6 : Combat, dégâts et mouvements.',
    },
    {
        'code': 'linguistique',
        'name': 'Linguistique',
    ...
    },
    {
        'code': 'mort-vivant',
        'name': 'Mort-vivant',
        'description': 'vous êtes un mort-vivant ramené à la vie par la nécromancie (cf. Chapitre 7 : La magie).Vous êtes immunisé contre la Peur, la Terreur, les coups assommants, le poison, les maladies et tous les sorts, compétences et effets relatifs à la manipulation des émotions et de l’esprit.',
    },
    {
        'code': 'orateur-ne',
        'name': 'Orateur né',
    ...
    },
    {
        'code': 'sombre-savoir',
        'name': 'Sombre savoir',
        'description': 'vous vous êtes laissé séduire par les arts interdits de la sorcellerie. Sombre savoir est un talent particulier car il n’est pas unique. Il existe différentes formes de ce talent. La concentration et la difficulté des études nécessaires sont telles qu’on ne peut en maîtriser qu’une seule forme. Chaque talent de Sombre savoir correspond à la parenthèses. Par exemple, Sombre savoir (Chaos) est différent de Sombre savoir (nécromancie). Les Sombres savoirs les plus répandus sont le Chaos et la nécromancie. De futurs suppléments en décriront de nouveaux en détail, parmi lesquels ceux des puissances du Chaos : Nurgle, Slaanesh et Tzeentch. Si vous connaissez un Sombre savoir, vous pouvez tenter de lancer n’importe quel sort dépendant de cette forme de magie. Reportez-vous au Chapitre 7 : La magie pour connaître la liste des sorts et autres détails.',
    },
    {
        'code': 'sur-ses-gardes',
        'name': 'Sur ses gardes',
    ...
    },
    {
        'code': 'terrifiant',
        'name': 'Terrifiant',
        'description': 'la simple vue de votre visage monstrueux fait fuir l’ennemi. Vous provoquez la Terreur, comme indiqué dans le Chapitre 9 : Le meneur de jeu',
    },
    {
        'code': 'tir-de-precision',
    ...
    },
    {
        'code': 'tireur-delite',
        'name': 'Tireur d’élite',
        'description': 'vous bénéficiez d’un bonus permanent de +10% en Capacité de Tir. Modifiez votre profil de départ en conséquence.',
    },
    {
        'code': 'troublant',
        'name': 'Troublant',
    ...
    },
    {
        'code': 'vol',
        'name': 'Vol',
        'description': 'vous savez voler. Pour plus de détails concernant le vol, reportez-vous au Chapitre 6 : Combat, dégâts et mouvements.',
    },
]
